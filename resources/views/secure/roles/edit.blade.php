                    ...
                    <form id="roleForm">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6 col-sm-6 col-12">
                                ...
                                <input type="text" name="landing_page_url" class="form-control"
                                    placeholder="Enter landing page url" value="{{ $role->landing_page_url }}" />
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="form-check">
                                                <input class="form-check-input selectGroup" type="checkbox"
                                                    data-group-name="{{ str_replace(' ', '', $group) }}"
                                                    id="selectGroup_{{ str_replace(' ', '', $group) }}">
                                            </div>
                                            <label for="selectGroup_{{ str_replace(' ', '', $group) }}"
                                                class="mt-1 fw-semibold">{{ $group }} Permissions</label>
                                        </div>
                                        <hr class="mb-0 mt-2">
                                    </div>
                                        ...
                                        @foreach($permissions as $permission)
                                            <div class="form-check w-25">
                                                <input type="checkbox" name="permissions[]" value="{{ $permission->name }}"
                                                    id="{{ $permission->name }}"
                                                    class="form-check-input permissions permissions_for_{{ str_replace(' ', '', $group) }}"
