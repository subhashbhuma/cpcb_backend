    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            <div>
                                @if ($governmentPortal->file_name)
                                    <img src="{{ generate_file_view_path_for_backend($governmentPortal->file_name_full_path) }}"
                                        alt="{{ $governmentPortal->title ?? '—' }}" class="img-fluid border"
                        ...
                        <div class="col-md-6 card py-2 bg-light mb-3">
                            ...
                            <p class="mb-0">{{ $governmentPortal->title ?? '—' }}</p>
                        </div>

                        <div class="col-md-6 card py-2 bg-light mb-3">
                            <label class="form-label"><strong>Title (Hindi):</strong></label>
                            <p class="mb-0">{{ $governmentPortal->title_hi ?? '—' }}</p>
                        </div>

                        <div class="col-md-12 card py-2 bg-light mb-3">
                            <label class="form-label"><strong>Portal Link:</strong></label>
                            <p class="mb-0">
                                @if ($governmentPortal->link)
                                    <a href="{{ $governmentPortal->link }}" target="_blank">{{ $governmentPortal->link }}</a>
                                @else
                                    —
                                @endif
                            </p>
                        ...
                        <div class="col-md-6 col-12 mb-3 card py-2 bg-light">
                            ...
                            <p class="mb-0">
                                {{ $governmentPortal->created_at->format('d M Y') }}
                            </p>
                        </div>
                        <div class="col-md-6 col-12 mb-3 card py-2 bg-light">
                            <label class="form-label">Created By</label>
                            <p class="mb-0">
                                {{ $governmentPortal->created_by_user ? $governmentPortal->created_by_user->name : 'N/A' }}
                            </p>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mb-3 card py-2 bg-light">
                            ...
                            <p class="mb-0">
                                {{ $governmentPortal->updated_at->format('d M Y') }}
                            </p>
                        </div>
                        <div class="col-md-6 col-12 mb-3 card py-2 bg-light">
                            <label class="form-label">Updated By</label>
                            <p class="mb-0">
                                {{ $governmentPortal->updated_by_user ? $governmentPortal->updated_by_user->name : 'N/A' }}
                            </p>
                        </div>
            ...
            <div class="card card-body">
                <div class="row">
                    <div class="col-md-6 card py-2 bg-light mb-3">
                        ...
                        <p class="mb-0">
                            @if ($governmentPortal->is_approved == 1)
                                <span class="badge bg-success">Approved</span>
                            @elseif ($governmentPortal->is_approved == 2)
        ...
        : '<span class="badge bg-warning text-dark">Not Published</span>' !!}
                    ...
                    <div class="col-md-6 card py-2 bg-light mb-3">
                        ...
                        <p class="mb-0">
                            {{ $governmentPortal->remarks ? $governmentPortal->remarks : 'No remarks available' }}
                        </p>
                    </div>
                    ...
                    <div class="col-md-6 card py-2 bg-light mb-3">
                        ...
                        <p class="mb-0">
                            {{ $governmentPortal->publish_remark ?: 'No publish remarks available' }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            if ($("#approveForm").length) {
                $("#approveForm").validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "{{ route('government-portals.approve', $governmentPortal->id) }}",
                            type: "POST",
                            data: formData,
                            processData: false,
                            contentType: false,
                            success: function (response) {
                                Swal.fire("Success!", response.message, "success")
                                    .then(() => window.location.href = "{{ route('government-portals.index') }}");
                            },
                            error: function (xhr) {
            ...
            if ($("#publishForm").length) {
                $("#publishForm").validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "{{ route('government-portals.publish', $governmentPortal->id) }}",
                            type: "POST",
                            data: formData,
                            processData: false,
                            contentType: false,
