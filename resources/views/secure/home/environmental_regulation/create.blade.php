        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Environmental Regulation Form -->
                    <form id="environmentalRegulationForm" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-plus"></i> Create Environmental Regulation
                            </button>
                        </div>
                    </form>
        ...
        $(document).ready(function () {
            ...
            $('#environmentalRegulationForm').validate({
                ...
                submitHandler: function (form) {
                    ...
                    if (window.editors) {
                        window.editors.forEach(({ editor, name }) => {
                            formData.set(name, editor.getData());
                        });
                    }

                    $.ajax({
                        url: "{{ route('environmental-regulation.store') }}",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
