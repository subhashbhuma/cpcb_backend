        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="informationCenterForm" action="{{ route('information-centers.update', $center->id) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="title" class="form-control"
                                    value="{{ old('title', $center->title) }}" required>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="title_hi" class="form-control"
                                    value="{{ old('title_hi', $center->title_hi) }}" required>
                            </div>
                        </div>

                        <div class="text-center">
                            <button type="submit" class="btn btn-success">
                                <i class="fa fa-save"></i> Update Information Center
                            </button>
                        </div>
