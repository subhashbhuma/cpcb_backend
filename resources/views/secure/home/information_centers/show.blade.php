    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-12 mb-3 card py-2 bg-light">
                            ...
                            <p class="mb-0">{{ $center->title }}</p>
                        </div>

                        <div class="col-md-6 col-12 mb-3 card py-2 bg-light">
                            <label class="form-label">Title (हिंदी):</label>
                            <p class="mb-0">{{ $center->title_hi }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-body">
                <div class="row">
                    <div class="col-md-6 card py-2 bg-light mb-3">
                        ...
                        <p class="mb-0">
                            @if ($center->is_approved == 1)
                                <span class="badge bg-success">Approved</span>
                            @elseif ($center->is_approved == 2)
        ...
        : '<span class="badge bg-warning text-dark">Not Published</span>' !!}
                    ...
                    <div class="col-md-6 card py-2 bg-light mb-3">
                        ...
                        <p class="mb-0">
                            {{ $center->remarks ?: 'No remarks available' }}
                        </p>
                    </div>
                    ...
                    <div class="col-md-6 card py-2 bg-light mb-3">
                        ...
                        <p class="mb-0">
                            {{ $center->publish_remark ?: 'No publish remarks available' }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                @can('approve information centers')
                ...
                @can('publish information centers')
                    <div class="col-md-6 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">
            ...
            if ($("#approveForm").length) {
                $("#approveForm").validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "{{ route('information-centers.approve', $center->id) }}",
                            type: "POST",
                            data: formData,
                            processData: false,
                            contentType: false,
                            success: function (response) {
                                Swal.fire("Success!", response.message, "success")
                                    .then(() => window.location.href = "{{ route('information-centers.index') }}");
                            },
                            error: function (xhr) {
            ...
            if ($("#publishForm").length) {
                $("#publishForm").validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "{{ route('information-centers.publish', $center->id) }}",
                            type: "POST",
                            data: formData,
                            processData: false,
                            contentType: false,
