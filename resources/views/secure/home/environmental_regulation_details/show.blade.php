...
@section('content')
    <!-- [ Page Header ] start -->
    <x-page-header title="View Environmental Regulation Detail" :backButton="true" />
    <!-- [ Page Header ] end -->
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 card py-2 bg-light mb-3">
                            ...
                            <p class="mb-0">
                                {{ optional($detail->environmentalRegulation)->title ?? 'N/A' }}
                            </p>
                        </div>
                        ...
                        <div class="col-md-6 card py-2 bg-light mb-3">
                            ...
                            <p class="mb-0">{{ $detail->parent ? $detail->parent->title : '— (Top Level)' }}</p>
                        </div>

                        <div class="col-md-6 card py-2 bg-light mb-3">
                            <label class="form-label"><strong>Order:</strong></label>
                            <p class="mb-0">{{ $detail->order ?? 0 }}</p>
                        </div>
        ...
        : '<span class="badge bg-warning text-dark">Not Published</span>' !!}
                    ...
                    <div class="col-md-6 card py-2 bg-light mb-3">
                        ...
                        <p class="mb-0">
                            {{ $detail->publish_remark ? $detail->publish_remark : 'No publish remarks available' }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <!-- APPROVE / PUBLISH -->
            <div class="row">
                @can('approve environmental regulation')
                    <div class="col-md-6">
                        <div class="card">
                ...
                @can('publish environmental regulation')
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
        ...
        $(function () {
            $("#approveForm").validate({
                ...
                submitHandler: function (form) {
                    $.ajax({
                        url: "{{ route('environmental-regulation-details.approve', $detail->id) }}",
                        type: "POST",
                        ...
                        success: res => {
                            Swal.fire("Success", res.message, "success")
                                .then(() => window.location.href = "{{ route('environmental-regulation-details.index') }}");
                        },
                        error: xhr => {
                            const msg = xhr.status === 422 ? Object.values(xhr.responseJSON.errors).flat().join("<br>") : "Something went wrong!";
            ...
            $("#publishForm").validate({
                ...
                submitHandler: function (form) {
                    $.ajax({
                        url: "{{ route('environmental-regulation-details.publish', $detail->id) }}",
                        type: "POST",
                        data: new FormData(form),
                        processData: false,
                        contentType: false,
