...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 card py-2 bg-light mb-3">
                            ...
                            <p class="mb-0">{{ $Complaint->full_name }}</p>
                        </div>
                        ...
                        <div class="col-md-6 card py-2 bg-light mb-3">
                            ...
                            <p class="mb-0">{{ $Complaint->phone ?? 'N/A' }}</p>
                        </div>

                        <div class="col-md-6 card py-2 bg-light mb-3">
                            <label class="form-label"><strong>Subject:</strong></label>
                            <p class="mb-0">{{ $Complaint->complaintSubject->title ?? 'N/A' }}</p>
                        </div>

                        <div class="col-md-6 card py-2 bg-light mb-3">
                            <label class="form-label"><strong>Status:</strong></label>
                            <p class="mb-0">{!! $Complaint->status_badge !!}</p>
                        </div>

                        <div class="col-md-6 card py-2 bg-light mb-3">
                            <label class="form-label"><strong>Submitted On:</strong></label>
                            <p class="mb-0">{{ $Complaint->created_at->format('d M Y, h:i A') }}</p>
                        </div>
                        ...
                        <div class="col-md-6 col-12 card py-2 bg-light mb-3">
                            ...
                            <p class="mb-0">
                                @if ($Complaint->file_name)
                                    <a href="{{ generate_file_view_path_for_backend($Complaint->file_full_path) }}"
            ...
            <!-- Response History -->
            @if($Complaint->histories->count() > 0)
                <div class="card">
            ...
            $(document).ready(function () {
                $("#revertForm").validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "{{ route('complaint.send-revert', $Complaint->id) }}",
                            type: "POST",
                            data: formData,
                            processData: false,
                            contentType: false,
