                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12 card py-2 bg-light mb-3">
                            ...
                            <p class="mb-0">{{ $circular->division?->title ?? '—' }} /
                                {{ $circular->division?->title_hi ?? '—' }}
                            </p>
                        </div>

                        <div class="col-md-6 col-12 card py-2 bg-light mb-3">
                            <label class="form-label"><strong>Title (English):</strong></label>
                            <p class="mb-0">{{ $circular->title ?? '—' }}</p>
                        </div>

                        <div class="col-md-6 col-12 card py-2 bg-light mb-3">
                            <label class="form-label"><strong>Title (Hindi):</strong></label>
                            <p class="mb-0">{{ $circular->title_hi ?? '—' }}</p>
                        </div>

                        <div class="col-md-6 col-12 card py-2 bg-light mb-3">
                            <label class="form-label"><strong>Category:</strong></label>
                            <p class="mb-0">{{ $circular->circularCategory->name ?? '—' }}
                                ({{ $circular->circularCategory->name_hi ?? '' }})</p>
                        </div>

                        <div class="col-md-6 col-12 card py-2 bg-light mb-3">
                            <label class="form-label"><strong>Published Date:</strong></label>
                            <p class="mb-0">
                                {{ $circular->published_date ? $circular->published_date->format('d-m-Y') : '—' }}
                            </p>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mb-3 card py-2 bg-light">
                            ...
                            <p class="mb-0">
                                {{ $circular->created_by_user ? $circular->created_by_user->name : 'N/A' }}
                            </p>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mb-3 card py-2 bg-light">
                            ...
                            <p class="mb-0">
                                {{ $circular->updated_at->format('d M Y') }}
                            </p>
                        </div>
                        <div class="col-md-6 col-12 mb-3 card py-2 bg-light">
                            <label class="form-label">Updated By</label>
                            <p class="mb-0">
                                {{ $circular->updated_by_user ? $circular->updated_by_user->name : 'N/A' }}
                            </p>
                        </div>
            ...
            @if(!Auth::user()->hasRole('Employee'))
                ...
                <div class="card card-body">
                    <div class="row">
                        <div class="col-md-6 card py-2 bg-light mb-3">
                            ...
                            <p class="mb-0">
                                @if ($circular->is_approved == 1)
                                    <span class="badge bg-success">Approved</span>
                                @elseif ($circular->is_approved == 2)
                ...
                : '<span class="badge bg-warning text-dark">Not Published</span>' !!}
                        ...
                        <div class="col-md-6 card py-2 bg-light mb-3">
                            ...
                            <p class="mb-0">
                                {!! $circular->remarks ? $circular->remarks : '—' !!}
                            </p>
                        </div>
                        ...
                        <div class="col-md-6 card py-2 bg-light mb-3">
                            ...
                            <p class="mb-0">
                                {!! $circular->publish_remark ? $circular->publish_remark : '—' !!}
                            </p>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function () {
            ...
            if ($("#approveForm").length) {
                $("#approveForm").validate({
                    ...
                    submitHandler: function (form) {
                        $.ajax({
                            url: "{{ route('circulars.approve', $circular->id) }}",
                            type: "POST",
                            data: $(form).serialize(),
            ...
            if ($("#publishForm").length) {
                $("#publishForm").validate({
                    ...
                    submitHandler: function (form) {
                        $.ajax({
                            url: "{{ route('circulars.publish', $circular->id) }}",
                            type: "POST",
                            data: $(form).serialize(),
                            success: function (response) {
                                Swal.fire("Success!", response.message, "success").then(() => {
