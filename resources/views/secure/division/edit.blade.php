        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="divisionForm" action="{{ route('division.update', $record->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12 mb-3">
                                <div class="form-check form-switch mt-4 pt-2">
                                    <input class="form-check-input" type="checkbox" name="is_new" id="is_new" value="1" {{ old('is_new', $record->is_new) ? 'checked' : '' }}>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-success">
                                <i class="fa fa-save"></i> Update Division
                            </button>
                        </div>
