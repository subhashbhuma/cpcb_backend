                        ...
                        <div class="row">
                            <div class="col-md-12 col-12 mb-3">
                                ...
                                <select name="job_id" class="form-control select2" required>
                                    ...
                                    @foreach($jobs as $job)
                                        <option value="{{ $job->id }}" {{ $jobPost->job_id == $job->id ? 'selected' : '' }}>
                                            {{ $job->title }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <input type="text" name="title" id="title" class="form-control" value="{{ $jobPost->title }}"
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <input type="text" name="title_hi" id="title_hi" class="form-control" value="{{ $jobPost->title_hi }}"
        ...
        $(document).ready(function () {
            ...
            $("#jobPostEditForm").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ route('job-posts.update', $jobPost->id) }}",
                        method: "POST",
                        data: formData,
