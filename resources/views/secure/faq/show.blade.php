    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 card py-2 bg-light mb-3">
                            ...
                            <p class="mb-0">{{ $faq->question_hi ?? '—' }}</p>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mb-3 card py-2 bg-light">
                            ...
                            <p class="mb-0">
                                {{ $faq->created_by_user ? $faq->created_by_user->name : 'N/A' }}
                            </p>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mb-3 card py-2 bg-light">
                            ...
                            <p class="mb-0">
                                {{ $faq->updated_by_user ? $faq->updated_by_user->name : 'N/A' }}
                            </p>
                        </div>
            ...
            <div class="card card-body">
                <div class="row">
                    <div class="col-md-6 card py-2 bg-light mb-3">
                        ...
                        <p class="mb-0">
                            @if ($faq->is_approved == 1)
                                <span class="badge bg-success">Approved</span>
                            @elseif ($faq->is_approved == 2)
        ...
        : '<span class="badge bg-warning text-dark">Not Published</span>' !!}
                    ...
                    <div class="col-md-6 card py-2 bg-light mb-3">
                        ...
                        <p class="mb-0">
                            {!! $faq->publish_remark ? $faq->publish_remark : '—' !!}
                        </p>
                    </div>
                </div>
            </div>
