                    ...
                    <form id="portalForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <input type="text" name="title" class="form-control" value="{{ $eprPortal->title }}"
                                    required />
                            </div>
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <input type="text" name="title_hi" class="form-control" value="{{ $eprPortal->title_hi }}"
                                    required />
                            </div>

                            <div class="col-md-12 col-12 mb-3">
                                <label class="form-label">Portal Link: <span class="text-danger">*</span></label>
                                <input type="text" name="link" class="form-control" value="{{ $eprPortal->link }}"
                                    required />
                            </div>
                            ...
                            <div class="col-md-12 col-12 mb-3">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_live" value="1" {{ $eprPortal->is_live ? 'checked' : '' }}>
        ...
        $(document).ready(function () {
            $("#portalForm").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ route('epr-portals.update', $eprPortal->id) }}",
                        method: "POST",
                        data: formData,
                        contentType: false,
                        processData: false,
