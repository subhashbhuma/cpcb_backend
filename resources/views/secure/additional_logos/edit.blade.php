                    ...
                    <form id="sliderForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                @if ($additionalLogo->file_name)
                                    <div class="mt-2">
                                        ...
                                        <img src="{{ $additionalLogo->file_url }}" alt="Additional Logo Image" class="img-fluid"
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <input type="text" name="title" class="form-control" value="{{ $additionalLogo->title }}" />
                            </div>

                            <div class="col-md-6 col-12 mb-3">
                                <label class="form-label">Title (Hindi):</label>
                                <input type="text" name="title_hi" class="form-control"
                                    value="{{ $additionalLogo->title_hi }}" />
                            </div>

                            <div class="col-md-12 col-12 mb-3">
                                <label class="form-label">Link:</label>
                                <input type="url" name="link" class="form-control" value="{{ $additionalLogo->link }}" />
                            </div>
        ...
        $(document).ready(function () {
            $("#sliderForm").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ route('additional-logos.update', $additionalLogo->id) }}",
                        method: "POST",
                        data: formData,
                        contentType: false,
                        processData: false,
