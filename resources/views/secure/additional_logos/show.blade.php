    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 card py-2 bg-light mb-3">
                            ...
                            <div>
                                @if ($additionalLogo->file_name)
                                    <img src="{{ $additionalLogo->file_url }}" alt="Additional Logo Image"
                                        class="img-fluid show-preview-image">
                                @else
                        ...
                        <div class="col-md-6 card py-2 bg-light mb-3">
                            ...
                            <p class="mb-0">{{ $additionalLogo->title ?? '—' }}</p>
                        </div>

                        <div class="col-md-6 card py-2 bg-light mb-3">
                            <label class="form-label"><strong>Title (Hindi):</strong></label>
                            <p class="mb-0">{{ $additionalLogo->title_hi ?? '—' }}</p>
                        </div>

                        <div class="col-md-6 card py-2 bg-light mb-3">
                            <label class="form-label"><strong>Link:</strong></label>
                            <p class="mb-0">{{ $additionalLogo->link ?? '—' }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-body">
                <div class="row">
                    <div class="col-md-6 card py-2 bg-light mb-3">
                        ...
                        <p class="mb-0">
                            @if ($additionalLogo->is_approved == 1)
                                <span class="badge bg-success">Approved</span>
                            @elseif ($additionalLogo->is_approved == 2)
        ...
        : '<span class="badge bg-warning text-dark">Not Published</span>' !!}
                    ...
                    <div class="col-md-6 card py-2 bg-light mb-3">
                        ...
                        <p class="mb-0">
                            {{ $additionalLogo->remarks ? $additionalLogo->remarks : 'No remarks available' }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            $(document).ready(function () {
                ...
                $("#approveForm").validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "{{ route('additional-logos.approve', $additionalLogo->id) }}",
                            type: "POST",
                            data: formData,
                            processData: false,
                            contentType: false,
            ...
            $(document).ready(function () {
                ...
                $("#publishForm").validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "{{ route('additional-logos.publish', $additionalLogo->id) }}",
                            type: "POST",
                            data: formData,
                            processData: false,
                            contentType: false,
