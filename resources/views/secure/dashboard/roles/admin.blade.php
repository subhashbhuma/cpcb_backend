        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <p class="mb-0 text-muted">Total Visitors (As on Date)</p>
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <p class="mb-0 text-muted">Media Files</p>
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <p class="mb-0 text-muted">Total Queries/Feedback (As on Date)</p>
                    <span class="badge bg-light-primary">{{ $stats['feedback'] }}</span>
                </div>
                <div class="d-flex align-items-center justify-content-between">
                    <p class="mb-0 text-muted">Total Air Polution Complaints (As on Date)</p>
