...
@section('content')
    <!-- [ Page Header ] start -->
    <x-page-header title="Add Page Category" :backButton="true" />
                ...
                <div class="card-body">
                    ...
                    <form id="pageCatForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                <label class="form-label" for="file_name">File (English) </label>
                                <input type="file" name="file_name" id="file_name" class="form-control"
                                    accept=".pdf,.doc,.docx">
                            </div>

                            <div class="col-md-6 col-12 mb-3">
                                <label class="form-label" for="file_name_hi">File (हिंदी) </label>
                                <input type="file" name="file_name_hi" id="file_name_hi" class="form-control"
                                    accept=".pdf,.doc,.docx">
                            </div>
