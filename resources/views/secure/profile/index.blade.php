                            ...
                            <div class="text-center">
                                <div class="chat-avtar d-inline-flex mx-auto">
                                    <img class="rounded-circle img-fluid"
                                        src="{{ asset('storage' . Config::get('file_paths')['USER_PROFILE_IMAGE_PATH'] . '/' . auth()->user()->profile_image) }}"
                                        alt="User image" style="width: 100px; height: 126px;" />
                                </div>
                    ...
                    <div class="tab-content" id="user-set-tabContent">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control form-control-file"
                                                        name="profile_image" accept=".jpg, .png, .jpeg, .webp" />
                                                    <span class="text-danger">Only accept .jpg, .png, .jpeg, .webp
                                                        file types. Max file size 1MB.</span>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Email Address or CPCB Number</label>
                        ...
                        <div class="tab-pane fade" id="user-cont-3" role="tabpanel">
                            <form id="changePasswordForm"
                                action="{{ route('profile.change-password', auth()->user()->id) }}" method="POST">
                                @csrf
                                @method('POST')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item">✔ At least 1 special character (!@#$%^&*)
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
    ...
    <script @cspNonce>
        ...
        $('#changePasswordForm').validate({
            ...
            submitHandler: async function (form, event) {
                ...
                if (encryptionKey) {
                    formData.set('old_password', await encryptPassword(formData.get('old_password'), encryptionKey));
                    formData.set('new_password', await encryptPassword(formData.get('new_password'), encryptionKey));
                    formData.set('new_password_confirmation', await encryptPassword(formData.get('new_password_confirmation'), encryptionKey));
                }
