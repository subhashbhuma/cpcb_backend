        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Add New Head Office</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('head_offices.store') }}" method="POST" enctype="multipart/form-data"
                        id="createForm">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Divisional Head & Designation <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="title" class="form-control" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Divisional Head & Designation (Hindi) <x-translate-button source="title" target="title_hi" /></label>
        ...
        $(document).ready(function () {
            ...
            $('#createForm').validate({
                ...
                messages: {
                    ...
                    title: 'Please enter Name of Divisional Head',
                    title_hi: 'Please enter Designation',
                },
