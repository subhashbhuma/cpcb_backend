                    ...
                    <form id="technicalReportForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <select name="subject_area_id" id="subject_area_id" class="form-control" required>
                                    ...
                                    @foreach ($subjectAreas as $subjectArea)
                                        <option value="{{ $subjectArea->id }}">{{ $subjectArea->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <small class="text-muted">Allowed: PDF. Max: 50MB</small>
                            </div>
                            ...
                            <div class="col-12 text-center">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-save"></i> Save Technical Report
                                </button>
                            </div>
                        </div>
                    </form>
        ...
        $(document).ready(function () {
            ...
            $("#technicalReportForm").validate({
                ...
                messages: {
                    ...
                    file_name: {
                        required: "Please upload English PDF file",
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ route('technical_report.store') }}",
                        method: "POST",
                        data: formData,
                        contentType: false,
                        processData: false,
