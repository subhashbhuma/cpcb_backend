                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12 mb-3">
                            <div class="card py-2 px-3 bg-light h-100">
                                <label class="form-label"><strong>Subject Area:</strong></label>
                                <p class="mb-0">{{ $report->subjectArea?->title ?? '—' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mb-3">
                            <div class="card py-2 px-3 bg-light h-100">
                                ...
                                <p class="mb-0">{{ $report->division?->title ?? '—' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mb-3">
                            <div class="card py-2 px-3 bg-light h-100">
                                ...
                                <p class="mb-0">{{ $report->title_hi ?? '—' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mb-3">
                            <div class="card py-2 px-3 bg-light h-100">
                                ...
                                <p class="mb-0">
                                    {{ $report->release_date ? \Carbon\Carbon::parse($report->release_date)->format('d M, Y') : '—' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mb-3">
                            <div class="card py-2 px-3 bg-light h-100">
                                ...
                                <p class="mb-0">{!! $report->publish_remark ?? '—' !!}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mb-3">
                            <div class="card py-2 px-3 bg-light h-100">
                                ...
                                <p class="mb-0">
                                    @if ($report->file_name)
                                        <a href="{{ generate_file_view_path_for_backend($report->file_url) }}"
                            ...
                            <div class="card py-2 px-3 bg-light h-100">
                                ...
                                <p class="mb-0">
                                    @if ($report->file_name_hi)
                                        <a href="{{ generate_file_view_path_for_backend($report->file_url_hi) }}"
                                            target="_blank">View Document</a>
                                    @else
                                        <span class="text-muted">No file uploaded.</span>
                                    @endif
                        ...
                        <div class="col-md-6 col-12 mb-3 ">
                            <div class="card py-2 px-3 bg-light h-100">
                                ...
                                <p class="mb-0">
                                    {{ $report->created_by_user ? $report->created_by_user->name : 'N/A' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mb-3 ">
                            <div class="card py-2 px-3 bg-light h-100">
                                ...
                                <p class="mb-0">
                                    {{ $report->updated_by_user ? $report->updated_by_user->name : 'N/A' }}
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        $(document).ready(function () {
            ...
            if ($("#approveForm").length) {
                $("#approveForm").validate({
                    ...
                    submitHandler: function (form) {
                        $.ajax({
                            url: "{{ route('technical_report.approve', $report->id) }}",
                            type: "POST",
                            data: $(form).serialize(),
                            success: function (response) {
                                Swal.fire("Success!", response.message, "success").then(() => {
                                    window.location.href = "{{ route('technical_report.index') }}";
                                });
                            },
                            error: function (xhr) {
                                if (xhr.status === 422) {
            ...
            if ($("#publishForm").length) {
                $("#publishForm").validate({
                    ...
                    submitHandler: function (form) {
                        $.ajax({
                            url: "{{ route('technical_report.publish', $report->id) }}",
                            type: "POST",
                            data: $(form).serialize(),
                            success: function (response) {
                                Swal.fire("Success!", response.message, "success").then(() => {
