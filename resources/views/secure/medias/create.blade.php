                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <small class="text-muted mb-0">
                                    Max allowed size 100MB. Supported formats:
                                    jpg,jpeg,png,gif,webp,pdf,doc,docx,xls,xlsx,mp4
                                </small>
                            </div>
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                <label class="form-label">Alt Text/Title (Hindi): <x-translate-button source="alt_text"
                                        target="alt_text_hi" />
                                </label>
                                <input type="text" name="alt_text_hi" class="form-control" />
                            </div>
