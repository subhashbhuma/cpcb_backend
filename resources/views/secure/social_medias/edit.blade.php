                    ...
                    <form id="socialMediaForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <input type="text" name="name" class="form-control" value="{{ $socialMedia->name }}"
                                    required />
                            </div>

                            <div class="col-md-12 col-12 mb-3">
                                <label class="form-label">URL: <span class="text-danger">*</span></label>
                                <input type="url" name="url" class="form-control" value="{{ $socialMedia->url }}"
                                    required />
                            </div>

                            <div class="col-md-12 col-12 mb-3">
                                <label class="form-label">Embed Code: <span class="text-danger">*</span></label>
                                <textarea name="embed_code" class="form-control" rows="3"
                                    required>{{ $socialMedia->embed_code }}</textarea>
                            </div>

                            <div class="col-md-6 col-12 mb-3">
                                <label class="form-label">Icon Class:</label>
                                <input type="text" name="icon_class" class="form-control"
                                    value="{{ $socialMedia->icon_class }}" placeholder="e.g., fa fa-facebook" />
                            </div>
