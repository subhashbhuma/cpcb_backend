        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="tenderCategoryForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <input type="text" name="title_hi" id="title_hi" class="form-control"
                                    value="{{ $tender_category->title_hi }}" />
                            </div>
        ...
        $(document).ready(function () {
            $("#tenderCategoryForm").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ route('tender_category.update', $tender_category->id) }}",
                        method: "POST",
                        data: formData,
                        contentType: false,
                        processData: false,
