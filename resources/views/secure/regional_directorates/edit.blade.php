        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="editForm" enctype="multipart/form-data" action="javascript:void(0)">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="regional_directorate" class="form-label">Regional Directorate</label>
                                <input type="text" class="form-control" id="regional_directorate"
                                    name="regional_directorate"
                                    value="{{ old('regional_directorate', $regionalDirectorate->regional_directorate) }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="regional_directorate_hi"
                                    name="regional_directorate_hi"
                                    value="{{ old('regional_directorate_hi', $regionalDirectorate->regional_directorate_hi) }}">
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="title" class="form-label">Name of Regional Director <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="title" name="title"
                                    value="{{ old('title', $regionalDirectorate->title) }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="title_hi" name="title_hi"
                                    value="{{ old('title_hi', $regionalDirectorate->title_hi) }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="designation" name="designation"
                                    value="{{ old('designation', $regionalDirectorate->designation) }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="designation_hi" name="designation_hi"
                                    value="{{ old('designation_hi', $regionalDirectorate->designation_hi) }}">
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="email" class="form-label">Email</label>
                                <input type="text" class="form-control" id="email" name="email"
                                    value="{{ old('email', $regionalDirectorate->email) }}">
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control" id="page-editor"
                                    name="description">{{ old('description', $regionalDirectorate->description) }}</textarea>
                            </div>
                            <div class="col-12 mb-3">
        ...
        $(document).ready(function () {
            ...
            $('#editForm').validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ route('regional_directorates.update', $regionalDirectorate->id) }}",
                        method: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
