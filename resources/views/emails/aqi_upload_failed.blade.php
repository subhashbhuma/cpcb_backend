...
<head>
    <meta charset="utf-8">
    <title>CPCB Alert: AQI Upload Failure</title>
</head>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.06); overflow: hidden; border: 1px solid #e5e5e5;">
        ...
        <tr>
            <td style="background-color: #171717; padding: 24px 30px; text-align: center; border-bottom: 3px solid #ef4444;">
                <h2 style="color: #ffffff; margin: 0; font-size: 22px; font-weight: 600; letter-spacing: 0.5px;">System Upload Alert</h2>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding: 35px 30px;">
                ...
                <p style="font-size: 15px; line-height: 1.6; margin-bottom: 25px; color: #404040;">
                    The automated service was interrupted while attempting to process a file upload. Please review the specific file and error details below:
                </p>
                ...
                <div style="background-color: #fafafa; border: 1px solid #e5e5e5; border-radius: 6px; padding: 15px;">
                    <p style="font-size: 14px; color: #525252; margin: 0; line-height: 1.5;">
                        <strong style="color: #171717;">Resolution:</strong> If correcting this issue manually, please ensure that the filename precisely adheres to the format: <span style="font-family: monospace; background: #e5e5e5; padding: 2px 6px; border-radius: 3px; color: #171717;">AQI_Bulletin_YYYYMMDD.pdf</span>
                    </p>
                </div>
            </td>
        </tr>
