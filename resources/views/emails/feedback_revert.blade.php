...
<body>
    <div class="container">
        ...
        <div class="card-body">
            <h2>Official Response to Feedback</h2>
            
            <div class="salutation">Dear {{ $feedback->full_name }},</div>
            <p class="intro-text">Thank you for submitting your feedback to the Central Pollution Control Board. We have processed your submission and an official response is detailed below:</p>

            <div class="info-box">
                <strong>Feedback Subject:</strong> {{ $feedback->subject->title ?? 'N/A' }}<br>
                <strong>Submitted On:</strong> {{ $feedback->created_at->format('d M Y, h:i A') }}
            </div>
