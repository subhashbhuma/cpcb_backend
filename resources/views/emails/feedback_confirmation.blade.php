...
<body>
    <div class="container">
        ...
        <div class="card-body">
            ...
            <p class="intro-text">Thank you for contacting the Central Pollution Control Board. Your feedback has been submitted successfully.</p>
          
            <div class="divider"></div>
            <p class="help-text">This is an automated acknowledgment email.</p>
        </div>
    </div>
