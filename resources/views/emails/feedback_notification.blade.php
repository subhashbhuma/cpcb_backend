...
<body>
    <div class="container">
        ...
        <div class="card-body">
            <h2>New Public Feedback Submission</h2>
            <div class="ticket-badge">Query ID: ID–{{ $feedback->id }}</div>
            ...
            <table class="details-table">
                ...
                <tr>
                    <th>Email Address</th>
                    <td><a href="mailto:{{ $feedback->email }}" style="color: #0f8546; text-decoration: none;">{{ $feedback->email ?? 'N/A' }}</a></td>
                </tr>
                <tr>
                    <th>Mobile Number</th>
            ...
            @if($feedback->file_name)
                <div class="attachment-box">
                    ...
                    <span class="attachment-text">An attachment was uploaded with this feedback. Please review it in the admin dashboard.</span>
                </div>
            @endif
