...
class StoreStudiesReportRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'file_name' => 'required|file|mimes:pdf,docx,doc|max:10240', // Max 10MB
            'file_name_hi' => 'nullable|file|mimes:pdf,docx,doc|max:10240',
        ];
    }
    ...
    public function messages(): array
{
    return [
        ...
        'division_id.required' => 'Please select the Division.',
