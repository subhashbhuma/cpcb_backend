...
class UpdateTenderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'issuing_authority' => 'nullable|string|max:255|regex:/^[\p{L}\p{N}\p{M}\s\.\,\-_&\(\)\:\;\'’"\/@#\$%?!\+=\[\]\*।॥–—]*$/u',
            'issuing_authority_hi' => 'nullable|string|max:255|regex:/^[\p{L}\p{N}\p{M}\s\.\,\-_&\(\)\:\;\'’"\/@#\$%?!\+=\[\]\*।॥–—]*$/u',
            'publish_date' => 'required|date',
            'start_date' => 'required|date|before_or_equal:end_date',
            'end_date' => 'nullable|date|after_or_equal:start_date',
            'file_name' => 'file|mimes:pdf|max:51200',
            'file_name_hi' => 'file|mimes:pdf|max:51200',
        ];
    }
    ...
    public function messages(): array
{
    return [
        ...
        'issuing_authority.max' => 'The Issuing Authority must not exceed 255 characters.',
        'issuing_authority.regex' => 'Please enter a valid Issuing Authority.',

        'issuing_authority_hi.max' => 'The Hindi Issuing Authority must not exceed 255 characters.',
        'issuing_authority_hi.regex' => 'Please enter a valid Hindi Issuing Authority.',
        ...
        'start_date.before_or_equal' => 'The Start Date must be the same as or earlier than the End Date.',
