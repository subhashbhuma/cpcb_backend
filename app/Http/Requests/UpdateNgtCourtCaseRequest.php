...
class UpdateNgtCourtCaseRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'qa_number' => 'nullable|string|max:255|regex:/^[\p{L}\p{N}\p{M}\s\.\,\-_&\(\)\:\;\'’"\/@#\$%?!\+=\[\]\*।॥–—]*$/u',
            'qa_number_hi' => 'nullable|string|max:255|regex:/^[\p{L}\p{N}\p{M}\s\.\,\-_&\(\)\:\;\'’"\/@#\$%?!\+=\[\]\*।॥–—]*$/u',
            'type' => 'nullable|string|max:100|regex:/^[\p{L}\p{N}\p{M}\s\.\,\-_&\(\)\:\;\'’"\/@#\$%?!\+=\[\]\*।॥–—]*$/u',
            'type_hi' => 'nullable|string|max:100|regex:/^[\p{L}\p{N}\p{M}\s\.\,\-_&\(\)\:\;\'’"\/@#\$%?!\+=\[\]\*।॥–—]*$/u',
    ...
    public function messages(): array
{
    return [
        ...
        'qa_number.max' => 'The Q&A Number must not exceed 255 characters.',
        'qa_number.regex' => 'Please enter a valid Q&A Number.',

        'qa_number_hi.max' => 'The Hindi Q&A Number must not exceed 255 characters.',
        'qa_number_hi.regex' => 'Please enter a valid Hindi Q&A Number.',

        'type.max' => 'The Type must not exceed 100 characters.',
        'type.regex' => 'Please enter a valid Type.',

        'type_hi.max' => 'The Hindi Type must not exceed 100 characters.',
        'type_hi.regex' => 'Please enter a valid Hindi Type.',
