...
class UpdateTechnicalReportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'remark' => 'nullable|string|max:255|regex:/^[\p{L}\p{N}\p{M}\s\.\,\-_&\(\)\:\;\'’"\/@#\$%?!\+=\[\]\*।॥–—]*$/u'
        ];
    }
...
{
    return [
        'subject_area_id.exists' => 'Please select a valid Subject Area.',
        ...
        'remark.max' => 'The Remark must not exceed 255 characters.',
        'remark.regex' => 'Please enter a valid Remark.',
    ];
}
