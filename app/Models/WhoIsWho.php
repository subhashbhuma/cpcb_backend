...
class WhoIsWho extends Model
{
    ...
    protected $appends = ['is_approved_desc', 'is_published_desc', 'image_full_path', 'hide_on_who_is_who_desc', 'show_on_homepage_desc','file_path'];
    ...
    {
        return $this->image ? base64_encode(Config::get('file_paths')['WHO_IS_WHO_IMAGE_PATH'] . '/' . $this->image) : null;
    }
