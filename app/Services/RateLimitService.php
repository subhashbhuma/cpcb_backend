...
class RateLimitService
{
     ...
     */
    public function checkOtpGenerationLimit(Request $request, User $user = null): array
    {
     ...
     */
    public function checkOtpResendLimit(Request $request, User $user = null): array
    {
        $ipAddress = $request->ip();
     ...
     */
    public function recordOtpGenerationAttempt(Request $request, User $user = null): void
    {
        $ipAddress = $request->ip();
        $action = self::OTP_GENERATION;
     ...
     */
    public function recordOtpResendAttempt(Request $request, User $user = null): void
    {
        $ipAddress = $request->ip();
        $action = self::OTP_RESEND;
     ...
     */
    public function checkBackendOtpGenerationLimit(Request $request, User $user = null): array
    {
        $ipAddress = $request->ip();
     ...
     */
    public function checkBackendOtpResendLimit(Request $request, User $user = null): array
    {
        $ipAddress = $request->ip();
     ...
     */
    public function recordBackendOtpGenerationAttempt(Request $request, User $user = null): void
    {
        $ipAddress = $request->ip();
        $action = self::BACKEND_OTP_GENERATION;
     ...
     */
    public function recordBackendOtpResendAttempt(Request $request, User $user = null): void
    {
        $ipAddress = $request->ip();
        $action = self::BACKEND_OTP_RESEND;
