...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const orangeModeToggle = document.getElementById("orange-mode-toggle");
    const blueModeToggle = document.getElementById("blue-mode-toggle");
    const greenModeToggle = document.getElementById("green-mode-toggle");
    ...
    if (savedTheme === "orange") {
        ...
        orangeModeToggle.innerHTML = "T";
        orangeModeToggle.setAttribute("aria-label", "Switch to light mode");
    }

    if (savedTheme === "blue") {
        document.body.classList.add("blue-mode");
        blueModeToggle.innerHTML = "T";
        blueModeToggle.setAttribute("aria-label", "Switch to light mode");
    }

    if (savedTheme === "green") {
        document.body.classList.add("green-mode");
        greenModeToggle.innerHTML = "T";
        greenModeToggle.setAttribute("aria-label", "Switch to light mode");
    }
    ...
    orangeModeToggle.addEventListener("click", () => {
        ...
        announceToScreenReader(
            `${
                document.body.classList.contains("orange-mode")
                    ? "Orange"
                    : "Light"
            } mode enabled`
        );
    ...
    blueModeToggle.addEventListener("click", () => {
        ...
        if (document.body.classList.contains("blue-mode")) {
            ...
            localStorage.setItem("theme", "light");
            blueModeToggle.innerHTML = "T";
            blueModeToggle.setAttribute("aria-label", "Switch to blue mode");
        }

        // Announce theme change to screen readers
        announceToScreenReader(
            `${
                document.body.classList.contains("blue-mode") ? "Blue" : "Light"
            } mode enabled`
        );
    });
    ...
    greenModeToggle.addEventListener("click", () => {
        ...
        if (document.body.classList.contains("green-mode")) {
            ...
            localStorage.setItem("theme", "light");
            greenModeToggle.innerHTML = "T";
            greenModeToggle.setAttribute("aria-label", "Switch to green mode");
        }

        // Announce theme change to screen readers
        announceToScreenReader(
            `${
                document.body.classList.contains("green-mode")
                    ? "Green"
                    : "Light"
            } mode enabled`
        );
