!(function (e, t) {
    ...
    var Y =
        ...
        ee = L("URLSearchParams"),
        te = E(["ReadableStream", "Request", "Response", "Headers"].map(L), 4),
        ne = te[0],
        re = te[1],
        oe = te[2],
        ie = te[3];
    ...
    var fe,
        le =
            ((fe = "undefined" != typeof Uint8Array && N(Uint8Array)),
            function (e) {
                return fe && e instanceof fe;
            }),
        de = L("HTMLFormElement"),
        pe = (function () {
        ...
        Re = {
            ...
            merge: function e() {
                for (
                    ...
                    u[s] = arguments[s];
                for (var c = 0, f = u.length; c < f; c++) u[c] && ae(u[c], i);
                return o;
            },
            ...
            isSpecCompliantForm: function (e) {
                return !!(e && J(e.append) && "FormData" === e[U] && e[D]);
            },
        ...
        return l(
                    ...
                    value: function (e) {
                        ...
                        return (
                            Re.forEach(this, function (r, o) {
                                ...
                                if (i)
                                    return ((t[i] = je(r)), void delete t[o]);
                                var a = e
                                    ? (function (e) {
                                          return e
                                              .trim()
            ...
            [
                ...
                },
                {
                    key: "accessor",
                    value: function (e) {
                        var t = (this[_e] = this[_e] = { accessors: {} })
                                .accessors,
                            n = this.prototype;
                        function r(e) {
                            var r = Te(e);
    ...
    (ke.accessor([
        ...
        Re.reduceDescriptors(ke.prototype, function (e, t) {
            var n = e.value,
                    ...
                    if (
                        ...
                        ((t = []),
                            e.forEach(function (e, n) {
                                var r = o(e);
                                Re.isUndefined(r) || (t[n] = r);
                            }));
                    else {
                        if (
                            !Re.isPlainObject(e) &&
                            (function (e) {
                                if (Re.hasOwnProp(e, "toJSON")) return !0;
                                for (
                        ...
                        for (
                            ...
                            var u = E(a[i], 2),
                                s = u[0],
                                c = u[1],
                                f = n.has(s.toLowerCase())
                                    ? "[REDACTED ****]"
                                    : o(c);
                            Re.isUndefined(f) || (t[s] = f);
                        }
                    }
                    return (r.pop(), t);
                }
                ...
                [
                    {
                        ...
                        value: function () {
                            var e = this.config,
                                t =
                                    e && Re.hasOwnProp(e, "redact")
                                        ? e.redact
                                        : void 0,
                                n =
                                    Re.isArray(t) && t.length > 0
                                        ? xe(e, t)
                                        : Re.toJSONObject(e);
                            return {
    ...
    var Fe = Re.toFlatObject(Re, {}, null, function (e) {
    ...
    function Le(e, t, n) {
        ...
        function l(e, n, o) {
            ...
            if (Re.isReactNative(t) && Re.isReactNativeBlob(e))
                return (t.append(Ue(o, n, i), f(e)), !1);
            if (e && !o && "object" === _(e))
                if (Re.endsWith(n, "{}"))
            ...
            return !!Ne(e) || (t.append(Ue(o, n, i), f(e)), !1);
        }
        var d = [],
            p = Object.assign(Fe, {
                defaultVisitor: l,
        ...
        return (
            (function e(n, r) {
                ...
                if (!Re.isUndefined(n)) {
                    ...
                    (d.push(n),
                        Re.forEach(n, function (n, a) {
                            !0 ===
                                (!(Re.isUndefined(n) || null === n) &&
                                    o.call(
                                        t,
                                        n,
                                        Re.isString(a) ? a.trim() : a,
                                        r,
                                        p,
    ...
    var He = (function () {
        ...
        Xe =
            Ke &&
            (!Ve ||
                ["ReactNative", "NativeScript", "NS"].indexOf(Ve.product) < 0),
        Ge =
            "undefined" != typeof WorkerGlobalScope &&
            self instanceof WorkerGlobalScope &&
            "function" == typeof self.importScripts,
        $e = (Ke && window.location.href) || "http://localhost",
        Qe = b(
            b(
                {},
                Object.freeze({
    ...
    var Ze = function (e, t) {
        return null != e && Re.hasOwnProp(e, t) ? e[t] : void 0;
    };
    var et = {
        transitional: Je,
        ...
        transformRequest: [
            function (e, t) {
                ...
                if (
                    ...
                    return o ? JSON.stringify(Ye(e)) : e;
                if (
                    Re.isArrayBuffer(e) ||
                    Re.isBuffer(e) ||
                    Re.isStream(e) ||
                ...
                if (i) {
                                ...
                                b(
                                    {
                                        visitor: function (e, t, n, r) {
                                            return Qe.isNode && Re.isBuffer(e)
                                                ? (this.append(
                                                      t,
                                                      e.toString("base64"),
                                                  ),
                    ...
                    if (
                        ...
                        var u = Ze(this, "env"),
                            s = u && u.FormData;
                        return Le(n ? { "files[]": e } : e, s && new s(), a);
                    }
                }
                return i || o
        ...
        transformResponse: [
            function (e) {
                var t = Ze(this, "transitional") || et.transitional,
                    n = t && t.forcedJSONParsing,
                    r = Ze(this, "responseType"),
                    o = "json" === r;
                if (Re.isResponse(e) || Re.isReadableStream(e)) return e;
                if (e && Re.isString(e) && ((n && !r) || o)) {
                    var i = !(t && t.silentJSONParsing) && o;
                    try {
                        return JSON.parse(e, Ze(this, "parseReviver"));
                    } catch (e) {
                        if (i) {
            ...
            Re.forEach(Object.keys(b(b({}, e), t)), function (r) {
                if (
                    ...
                    var i = Re.hasOwnProp(s, r) ? s[r] : o,
                        a = i(
                            Re.hasOwnProp(e, r) ? e[r] : void 0,
                            Re.hasOwnProp(t, r) ? t[r] : void 0,
                            r,
                        );
    ...
    var pt = ["content-type", "content-length"];
    var ht = function (e) {
            var t,
                n = dt({}, e),
                r = function (e) {
                    return Re.hasOwnProp(n, e) ? n[e] : void 0;
                },
                o = r("data"),
                i = r("withXSRFToken"),
                a = r("xsrfHeaderName"),
                ...
                d = r("url");
            if (
                ((n.headers = s = ke.from(s)),
                (n.url = ze(ft(f, d, l), e.params, e.paramsSerializer)),
                c &&
                    s.set(
                        "Authorization",
                        "Basic " +
                        ...
                        : Re.isFunction(o.getHeaders) &&
                          (function (e, t, n) {
                              "content-only" === n
                                  ...
                                  : e.set(t);
                          })(s, o.getHeaders(), r("formDataHeaderPolicy"))),
                Qe.hasStandardBrowserEnv) &&
                (Re.isFunction(i) && (i = i(n)),
                !0 === i || (null == i && st(n.url)))
            ) {
                var p = a && u && ct.read(u);
                p && s.set(a, p);
    ...
    function Ot(e) {
        ...
        var n = e.slice(5, t),
            r = e.slice(t + 1);
        if (/;base64/i.test(n)) {
            for (var o = r.length, i = r.length, a = 0; a < i; a++)
                if (37 === r.charCodeAt(a) && a + 2 < i) {
                    var u = r.charCodeAt(a + 1),
                        s = r.charCodeAt(a + 2);
                    ((u >= 48 && u <= 57) ||
                        (u >= 65 && u <= 70) ||
                        (u >= 97 && u <= 102)) &&
            ...
            (f >= 0 &&
                (61 === r.charCodeAt(f) ? (c++, f--) : l(f) && (c++, (f -= 3))),
                1 === c && f >= 0 && (61 === r.charCodeAt(f) || l(f)) && c++);
    ...
    var Et = "1.16.0",
        ...
        _t = function (e) {
            var t,
                n = null !== (t = Re.global) && void 0 !== t ? t : globalThis,
                r = n.ReadableStream,
                o = n.TextEncoder,
                i = (e = Re.merge.call(
                    { skipUndefined: !0 },
                ...
                s = i.Request,
                c = i.Response,
                f = u ? Rt(u) : "function" == typeof fetch,
                l = Rt(s),
                d = Rt(c);
            if (!f) return !1;
            var p,
                ...
                g =
                    ...
                    h &&
                    St(function () {
                        return Re.isReadableStream(new c("").body);
                    }),
                w = {
                    stream:
                        g &&
        ...
        Tt = function (e) {
            for (
                ...
                ((t = i[a]),
                    void 0 === (n = u.get(t)) &&
                        u.set(t, (n = a ? new Map() : _t(r))),
                    (u = n));
            return n;
        };
    Tt();
    var jt = { http: null, xhr: yt, fetch: { get: Tt } };
    Re.forEach(jt, function (e, t) {
        if (e) {
            try {
        ...
        getAdapter: function (e, t) {
            for (
                ...
                if (
                    ((r = n = e[a]),
                    !kt(n) &&
                        void 0 === (r = jt[(u = String(n)).toLowerCase()]))
                )
                    throw new Ce("Unknown adapter '".concat(u, "'"));
            ...
            xt
                ...
                .then(
                    function (t) {
                        ...
                        return ((t.headers = ke.from(t.headers)), t);
                    },
                    function (t) {
                        if (!nt(t) && (Ct(e), t && t.response)) {
                        ...
                        value: function (e, t) {
                            ...
                            (void 0 !== r &&
                                Ft.assertOptions(
                                    r,
                                    {
                                        silentJSONParsing: Lt.transitional(
                                            Lt.boolean,
                                        ),
                                        forcedJSONParsing: Lt.transitional(
                                            Lt.boolean,
                                        ),
                                        clarifyTimeoutError: Lt.transitional(
                                            Lt.boolean,
                                        ),
                                        legacyInterceptorReqResOrdering:
                                            Lt.transitional(Lt.boolean),
                                    },
                                    !1,
                                ),
                                null != o &&
    ...
    (Re.forEach(["delete", "get", "head", "options"], function (e) {
        ...
        Re.forEach(["post", "put", "patch", "query"], function (e) {
            function t(t) {
            ...
            ((Bt.prototype[e] = t()),
                "query" !== e && (Bt.prototype[e + "Form"] = t(!0)));
        }));
    var It = (function () {
        function e(t) {
    ...
    var Mt = (function e(t) {
        var n = new Bt(t),
            r = k(Bt.prototype.request, n);
        return (
            Re.extend(r, Bt.prototype, n, { allOwnKeys: !0 }),
    ...
    return (
        ...
        (Mt.mergeConfig = dt),
        (Mt.AxiosHeaders = ke),
        (Mt.formToJSON = function (e) {
            return Ye(Re.isHTMLForm(e) ? new FormData(e) : e);
        }),
        (Mt.getAdapter = xt.getAdapter),
        (Mt.HttpStatusCode = qt),
        (Mt.default = Mt),
        Mt
    );
});
