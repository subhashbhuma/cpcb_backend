        ...
        'default' => [
           ...
           'HTML.Doctype' => 'HTML 4.01 Transitional',
            ...
            'HTML.Allowed' => implode(',', [
                ...
                // HTML5 sectioning & interactive elements
                'section[style|class|id]',
                'details[style|class|id|open]',
                'summary[style|class|id]',

                // SVG support
                'svg[class|style|fill|stroke|viewbox|width|height]',
                'path[stroke-linecap|stroke-linejoin|stroke-width|d|fill|stroke]',
                ...
                // ADD THESE
                'video[src|type|width|height|poster|preload|controls|autoplay|loop|muted|playsinline|style|class]',
                'source[src|type]',
            ]),
